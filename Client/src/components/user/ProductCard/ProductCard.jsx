...
export default function ProductCard(props) {
  ...
  const handleLikeClick = async () => {
    ...
    const response = await makePostRequest("http://localhost:3000/wishlist", {
      userId,
      productId: data._id,
    });
  ...
  const handleAddBtn = async () => {
    ...
    const response = await makePostRequest("http://localhost:3000/cart", {
      userId,
      productId: data._id,
      quantity: 2,
    });
